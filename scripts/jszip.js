  ...
  _createClass(ZipUtils, null, [{
    ...
    value: function readAlphabetically(zip) {
      ...
      var priorityFiles = function priorityFiles(file) {
        return !(_.endsWith(file.relativePath, "extra.gbs") || _.endsWith(file.relativePath, "backpack.gbk") || _.endsWith(file.relativePath, "backpack.gbs") || _.endsWith(file.relativePath, "solutions.json"));
      };
